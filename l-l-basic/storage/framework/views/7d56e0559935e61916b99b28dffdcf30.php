<div class="max-w-md mx-auto p-6 bg-gray-100 rounded-lg">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white p-4 rounded text-center">
            ...
            <p class="text-3xl font-bold"><?php echo e($result); ?></p>
        </div>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/tools/livewire/l-l-basic/resources/views/livewire/calculator.blade.php ENDPATH**/ ?>