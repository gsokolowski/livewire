    ...
    <div class="grid grid-cols-3 gap-4 p-4">
        ...
        <div class="bg-green-100 p-4 rounded">
            ...
            <div class="text-center">
                <h1 class="text-4xl font-bold mb-4"><?php echo e($count); ?></h1>
                <div class="space-x-2">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/tools/livewire/l-l-basic/resources/views/livewire/counter.blade.php ENDPATH**/ ?>